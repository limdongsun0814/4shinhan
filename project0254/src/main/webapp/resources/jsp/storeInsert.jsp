...
var store_insert = document.getElementById("store_insert");
var img_index = 0;
var made_index= 0;
...
function add_origin(){
    ...
    $("#origin_div").append(` <div class="form-group2" style="margin-top: 3px;">
	...
	$.ajax({
		...
		success : function(res) {
			console.log(res.result);
			 if (res.result == true) {
				 store_insert.disabled = true;
				alert('이미 등록된 가게명입니다.');
			} else {
				store_insert.disabled = false;
				alert('등록 가능한 가게명입니다.');
			} 
		},
		error : function() {
