...
<body>
	...
	<form action="storeNoticeUpdate.do" method="POST"
					...
					<div class="full">
						<div class="insert">
							<input type="hidden" name=store_notice_seq
								value="${storeNotice.store_notice_seq }"> <input
								type="hidden" name=store_notice_store_id
								value="${storeNotice.store_notice_store_id }">
							<div class="title-container">
								<span>제목</span><input type="text" name=store_notice_title
									value="${storeNotice.store_notice_title }">
							</div>
							</br> </br>
							...
							</br> </br> <label>이미지 주소 : </label> <input type="hidden"
								name="store_notice_img_path" id="0_img_thumb_input"
								value="${storeNotice.store_notice_img_path}"> <input
								type="file" name="new_store_notice_img_path" id="new_img_input"
								onchange="setImgPath(event)">
</br>
							<div id="store_notice_image_preview" style="margin-top: 25px;">
								<img src="${storeNotice.store_notice_img_path}" id="upload_img"  width="200px" height="200px">
							</div>

							</br> </br> <input type="hidden" name=store_notice_date
								value="${storeNotice.store_notice_date }"></br> <input
								type="hidden" name=store_notice_view_count
								value="${storeNotice.store_notice_view_count }">


						</div>
					</div>
					</br>
					<button class="indoorbutton" type="submit">공지 사항 수정</button>
				</div>
			</div>
		</div>
	</form>
